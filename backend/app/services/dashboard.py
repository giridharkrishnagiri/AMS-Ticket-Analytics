...
DIRECT_APPLICATION_FIELDS = {
    ...
    "service_type": ApplicationInventoryItem.service_type,
    "service_entitlement": ApplicationInventoryItem.service_entitlement,
...
def volumetrics_source_select(
    ...
    *,
    ...
    return select(
        ...
        model.service_type.label("service_type"),
        model.service_entitlement.label("service_entitlement"),
